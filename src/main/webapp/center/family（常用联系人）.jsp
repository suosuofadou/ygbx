        ...
        <div class="main_width fix mycenter_box mycenter_contact">
            <div class="list_left" id="list_left">
                <ul>
                    ...
                    <li>
                        ...
                        <div>
                            <ul>
                                <li class="active"><a href="../YGBX/family（常用联系人）.html">常用联系人</a></li>
            ...
            <div class="mycenter_right fix">
                ...
                <div class="contact_list">
                    <a href="../YGBX/editfamily（添加常用联系人）.html" class="add_btn">添&nbsp;加</a>
                    <div class="tBox loading"></div>
                    <div class="tBox no_contact listNull">暂无常用联系人</div>
                    <div class="tBox list_box">
                        ...
                        <ul class="con">
                            <li class="fix">
                                <p class="name">王大锤</p>
                                <p class="type">身份证</p>
                                <p class="number">512426199104204133</p>
                                <p class="birth">1991-04-20</p>
                                <p class="sex">男</p>
                                <p class="operate">
