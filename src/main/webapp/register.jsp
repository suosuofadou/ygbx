...
<div class="wrapper">
    ...
    <div class="header_user">
        <div class="main_width">
            ...
            <span class="fr">
                ...
                <span class="Backlog"><a href="YGBX/book_detail（保单确认）.jsp">未完成订单<em>1</em></a></span>
    ...
    <div class="container">
        <div class="login_bg">
            <div class="form">
                <form action="RegisterServlet" method="post" name="loginForm" id="loginForm">
                    <h2>注册大特保网</h2>
                    <%--<div class="user_box">
                        <span class="icon"></span>
                        <input type="text" class="required userName" data-valid="isNonEmpty" data-error="用户名必填" name="uname" placeholder="用户名">
                    </div>--%>
                    <div class="tel_box">
                        <span class="icon"></span>
                        <input type="text" class="userTel" name="userTel" placeholder="请输入您的手机号" maxlength="11">
                    </div>
                    <div class="pwd_box">
                        <span class="icon"></span>
                    ...
                    <div class="pwd_box">
                        <span class="icon"></span>
                        <input type="password" class="userPwd" name="userPwd" placeholder="确认密码">
                    </div>
